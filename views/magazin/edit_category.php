...
<form method="post" action="/magazin/edit_category/?id_magazin=<?php echo $magazin["id_magazin"]; ?>">
    <p class="bold">Редактируем категорию в магазине <a href="/magazin/show_magazin/?id_magazin=<?php echo $magazin["id_magazin"]; ?>" class="title"><?php echo $magazin["domain_magazin"]; ?></a></p>
    <p>
    <div class="boxer">
